...
module functions in src/graph/. This adapter preserves the current label-guard,
...
from src.graph import cleanup as _cleanup
from src.graph import decisions as _decisions
from src.graph import edges as _edges
from src.graph import facts as _facts
from src.graph import session as _session
from src.graph.driver import close_driver, ensure_indexes, get_driver, init_driver
...
class Neo4jBackend:
    ...
    Delegates all operations to the existing src/graph/ module functions.
    ...
    def is_ready(self) -> bool:
        ...
        try:
            ...
            from src.graph.driver import _driver

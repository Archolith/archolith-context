...
- **Eval**: Added `scripts/real_session_gradeability.py` to triage candidate sessions into ready-to-grade, harness-blocked, manual-review, and evidence-gap buckets, including research/report outcome detection.
...
- **Audit**: Published `.agent/audits/2026-07-07-real-session-gradeability-triage.md`; 21 of 35 candidates are ready for first-pass grading from trace evidence, while 7 are now separated as harness-blocked before outcome.
